...
$sql = "SELECT * FROM dischead where tag1='entrepreneurs' or tag2='entrepreneurs' or tag3='entrepreneurs' or tag1='Entrepreneurs' or tag2='Entrepreneurs' or tag3='Entrepreneurs' ORDER BY count DESC";
