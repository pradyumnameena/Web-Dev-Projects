...
$sql = "SELECT * FROM dischead where tag1='journalism' or tag2='journalism' or tag3='journalism' or tag1='Journalism' or tag2='Journalism' or tag3='Journalism' ORDER BY count DESC";
