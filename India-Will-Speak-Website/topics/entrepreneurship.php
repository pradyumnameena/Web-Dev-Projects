...
$sql = "SELECT * FROM dischead where tag1='entrepreneurship' or tag2='entrepreneurship' or tag3='entrepreneurship' or tag1='Entrepreneurship' or tag2='Entrepreneurship' or tag3='Entrepreneurship' ORDER BY count DESC";
