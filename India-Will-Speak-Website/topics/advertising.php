...
$sql = "SELECT * FROM dischead where tag1='advertising' or tag2='advertising' or tag3='advertising' or tag1='Advertising' or tag2='Advertising' or tag3='Advertising' ORDER BY count DESC";
