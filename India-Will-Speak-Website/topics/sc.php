...
$sql = "SELECT * FROM dischead where tag1='Social Issue' or tag2='Social Issue' or tag3='Social Issue' or tag1='social issue' or tag2='social issue' or tag3='social issue' ORDER BY count DESC";
