...
$sql = "SELECT * FROM dischead where tag1='politician' or tag2='politician' or tag3='politician' or tag1='Politician' or tag2='Politician' or tag3='Politician' ORDER BY count DESC";
