...
$sql = "SELECT * FROM dischead where tag1='terrorism' or tag2='terrorism' or tag3='terrorism' or tag1='Terrorism' or tag2='Terrorism' or tag3='Terrorism' ORDER BY count DESC";
