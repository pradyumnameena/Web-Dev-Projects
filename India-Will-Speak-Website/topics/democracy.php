...
$sql = "SELECT * FROM dischead where tag1='democracy' or tag2='democracy' or tag3='democracy' or tag1='Democracy' or tag2='Democracy' or tag3='Democracy' ORDER BY count DESC";
