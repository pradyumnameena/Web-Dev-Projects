...
if(isset($_POST["identity2"])){
    ...
    if($resultus->num_rows>0){
        ...
        $us2 = "insert into ".$user2." (datatype,owner,partner,identity,following,priv) values ('disc',0,1,'$child',0,1)";
    ...
    $sql12 = "update discs set likes='$initl' where identity='$child' and priv=1";
    ...
    if($rf1->num_rows>0){
        ...
        $sqlf3 = "update dischead set likes='$lcount' where identity='$parent' and priv=1";
        ...
        $sqlg3 = "update discs set likes='$lcount' where identity='$parent' and priv=1";
