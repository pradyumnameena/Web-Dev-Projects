...
<!--<div class="row">-->
    ...
    <!--                <form class="modal-content animate" name="confirm" method="post" action="explore2.php">  -->
    <!--                <div class="imgcontainer">-->
...
echo "<div class='row'>";
echo "<div class='col-md-2' style='float:right;display:inline-block;'>";
echo "<div class='iconbar' style='height:40vh;'>";
echo "<div class='row'>";
echo "<div class='col-md-10'>";
              echo "<button type='button' id='popysl' class='btn btn-outline-primary'>Like</button>";
             echo "</div>";
             echo "<div id='modal-wrapperl' class='modal'>";
                   ...
                   echo "<div class='imgcontainer'>";
                       echo "<span id='cpopysl' class='close' title='Close PopUp'>&times;</span>";
                     echo "<h1 style='text-align:center'>Like Comment</h1>";
                   echo "</div>";
...
echo "<div class='col-md-10'>";
              echo "<button type='button' id='popysd' class='btn btn-outline-primary'>Dislike</button>";
             echo "</div>";
             echo "<div id='modal-wrapperd' class='modal'>";
                   echo "<form class='modal-content animate' name='confirm' method='post' action='dislike.php'>";  
                   echo "<div class='imgcontainer'>";
                       echo "<span id='cpopysd' class='close' title='Close PopUp'>&times;</span>";
                     echo "<h1 style='text-align:center'>Dislike Comment</h1>";
                   echo "</div>";
                   echo "<div class='container'>";
                     echo "<input type='text' placeholder='Enter Unique ID' name='identity2'>";
                     echo "<button type='submit'>Submit</button>";
...
echo "<div class='col-md-10'>";
              echo "<button type='button' id='popysco' class='btn btn-outline-success'>Comment</button>";
             echo "</div>";
             echo "<div id='modal-wrapperco' class='modal'>";
                   echo "<form class='modal-content animate' name='confirm' method='post' action='comment.php'>";  
                   echo "<div class='imgcontainer'>";
                       echo "<span id='cpopysco' class='close' title='Close PopUp'>&times;</span>";
                     echo "<h1 style='text-align:center'>Add Comment</h1>";
                   echo "</div>";
                   echo "<div class='container'>";
...
echo "<div class='col-md-10'>";
             ...
             echo "<div id='modal-wrapper' class='modal'>";
                   echo "<form class='modal-content animate' name='confirm' method='post' action='explore2.php'>";  
                   echo "<div class='imgcontainer'>";
                       echo "<span id='cpopys' class='close' title='Close PopUp'>&times;</span>";
...
echo "<div class='col-md-10'>";
              echo "<button type='button' id='popysr' class='btn btn-outline-warning'>Rate</button>";
             echo "</div>";
             echo "<div id='modal-wrapperr' class='modal'>";
                   echo "<form class='modal-content animate' name='confirm' method='post' action='rate.php'>";  
                   echo "<div class='imgcontainer'>";
                       echo "<span id='cpopysr' class='close' title='Close PopUp'>&times;</span>";
                     echo "<h1 style='text-align:center'>Rate Comment</h1>";
                   echo "</div>";
                   echo "<div class='container'>";
                     echo "<input type='text' placeholder='Enter Unique ID' name='identity'>";
...
echo "<div class='col-md-10'>";
              echo "<button type='button' id='popysra' class='btn btn-outline-danger'>Report</button>";
             echo "</div>";
             echo "<div id='modal-wrapperra' class='modal'>";
                   echo "<form class='modal-content animate' name='confirm' method='post' action='report.php'>";  
                   echo "<div class='imgcontainer'>";
                       echo "<span id='cpopysra' class='close' title='Close PopUp'>&times;</span>";
                     echo "<h1 style='text-align:center'>Report</h1>";
                   echo "</div>";
                   echo "<div class='container'>";
                     echo "<input type='text' placeholder='Enter Unique ID' name='identity'>";
                     echo "<button type='submit'>Submit</button>";
...
echo "</div>";
echo "</div>";
echo "<div class='col-md-10' style='height:100vh;overflow:scroll;float:left;'>";
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b5e7e388c000de9"></script>
</body>
</html>