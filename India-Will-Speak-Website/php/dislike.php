...
if($privres2->num_rows>0){
    ...
    if($resultus->num_rows>0){
        ...
        $us1 = "update ".$user2." set partner=3 where identity='$child'";
        ...
        $us2 = "insert into ".$user2." (datatype,owner,partner,identity,following) values ('disc',0,3,'$child',0)";
    ...
    $sql12 = "update discs set dislikes='$initl' where identity='$child'";
    ...
    if($rf1->num_rows>0){
        ...
        $sqlf3 = "update dischead set dislikes='$lcount' where identity='$parent'";
        ...
        $sqlg3 = "update discs set dislikes='$lcount' where identity='$parent'";
