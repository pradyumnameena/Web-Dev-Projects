...
$sql = "INSERT INTO dischead (heading,count,timeline,identity,likes,dislikes,tag1,tag2,tag3,imagelink,priv) 
						VALUES ('$message',0,'$diff','$val',0,0,'$first','$sec','$third','$vr',1)";
...
$sql2 = "insert into ".$user2." (datatype , owner , partner,identity,following,rating,priv) values ('disc',1,0,'$val',0,0,1)";
...
$fin2 = "insert into private (identity,owner) values ('$val','$user')";
...
<body>
	<div class="jumbotron text-center">
      <div class="container">
        <h1>Your discussion has been created. Share the unique id with your friends and discuss your topic here.</h1>
