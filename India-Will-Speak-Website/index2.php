  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="html/tour2.php">Tour</a></li>
        <li><a href="html/collab2.php">Collaborations</a></li>
            ...
            <div class="row text-center text-xs-center text-sm-left text-md-left">
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <ul class="list-unstyled quick-links">
                        ...
                        <li><a href="html/aboutus2.php"><i class="fa fa-angle-double-right"></i>About</a></li>
                        <li><a href="html/feedback.html"><i class="fa fa-angle-double-right"></i>Feedback</a></li>
                        <li><a href="html/privacy2.php"><i class="fa fa-angle-double-right"></i>Privacy Policy</a></li>
                        <li><a href="html/termsofservices2.php"><i class="fa fa-angle-double-right"></i>Terms of Services</a></li>
                    </ul>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <ul class="list-unstyled quick-links">
